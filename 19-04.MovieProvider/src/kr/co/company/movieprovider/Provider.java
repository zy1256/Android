package kr.co.company.movieprovider;
...
public class Provider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri
			.parse("content://kr.co.company.movieprovider/movies");
	...
	private static final UriMatcher matcher = new UriMatcher(
			UriMatcher.NO_MATCH);
	static {
		matcher.addURI("kr.co.company.movieprovider", "movies", MOVIE_COLLECTION);
		matcher.addURI("kr.co.company.movieprovider", "movies/#", SINGLE_MOVIE);
	}
