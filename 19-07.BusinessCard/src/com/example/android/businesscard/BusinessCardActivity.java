...
public class BusinessCardActivity extends Activity  {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == PICK_CONTACT_REQUEST && resultCode == RESULT_OK) {
			...
			Toast.makeText(getApplicationContext(), data.getData().toString(), 5000).show();
		}
	}
	...
	private void loadContactInfo(Uri contactUri) {
		 ...
		 */
		ContactInfo contactInfo= mContactAccessor.loadContact(getContentResolver(),contactUri);
		bindView(contactInfo);
	}
	/**
